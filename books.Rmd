...
**Out now!** [_Computing Geographically_](https://www.guilford.com/books/Computing-Geographically/David-O'Sullivan/9781462553938) argues for the importance of giscience taking geography seriously, and also for geography taking giscience more seriously. Too much giscience is conducted as if $(x,y)$ coordinates were all that is needed to make data geographical; equally, far too many geographers think that those coordinates are all that GISers care about. This book aims to bridge the divide. An accompanying website includes high resolution copies of all the figures, R and python code to produce many of the figures, and some 'bonus material' reflecting on various aspects of the project. See: [computinggeographically.org](https://computinggeographically.org).
