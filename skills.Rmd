...
### Analytics
I work all the time in R and python developing workflows to tidy, reformat, and analyse data, especially spatial data.

### Visualization
I am also a trained cartographer. I haven't done a lot of publication cartography _per se_, but spend a lot of my time putting together visual analytics or maps of complex data in research projects with which I am involved.

### Coding
I have been programming for as long a I can remember. The more or less full list of languages, with those I have taught in **bold** would be: (Apple) BASIC, PASCAL, Fortran, 6502 assembler (just a little), C/C++ (again, only a little), Java (my masters and Phd work), **NetLogo**, **Visual Basic** (yeuch), **Python**, **R**, and JavaScript (also HTML and CSS if you can call those programming languages). Like I say... I've been programming for a long time.
...
I'm sure I have other languages in me: Julia and Rust seem particularly interesting, but I may wait for more mature geospatial stacks to emerge before tackling them.
