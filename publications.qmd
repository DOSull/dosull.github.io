...
A similar list is available at my [ORCiD profile](https://orcid.org/0000-0001-8078-3241). You can also see them in citational context at [my google scholar page](https://scholar.google.com/citations?user=6guUlvgAAAAJ&hl=en&oi=ao), which is reasonably accurate.  Links below are generally to official publisher sources, and are often paywalled. Open access copies are linked from my [University of Auckland profile page](https://profiles.auckland.ac.nz/dosu004). If you would like a copy of something in particular and can't access it, then [get in touch](mailto:osullivan512@gmail.com).

Jump to [books](#books), [papers](#in-refereed-journals), [book chapters](#book-chapters), [dissertations](#dissertations)

::: {.bib}
## Books
Sila-Nowicka K, A Moore, **D O’Sullivan**, B Adams, and M Gahegan eds. 2025. [13th International Conference on Geographic Information Science (GIScience 2025)](https://dx.doi.org/10.4230/LIPICS.GISCIENCE.2025). LIPIcs 346. Leibniz International Proceedings in Informatics (LIPIcs). Schloss Dagstuhl – Leibniz-Zentrum für Informatik.

**O’Sullivan D**. 2024. _Computing Geographically: Bridging Giscience and Geography_ (Guilford Press: New York).
...
**O’Sullivan D** and FJ Morgan. Online First 2026. Modeling potential environmental impacts of science activity in Antarctica. _Transactions in GIS_ **30**(5), e70369. doi: [10.1111/tgis.70369](https://doi.org/10.1111/tgis.70369).

**O'Sullivan D**, L Bergmann. 2026. Using MapWeaver to make tiled and woven maps of multivariate thematic data. _Cartographic Perspectives_ **108**. doi: [10.14714/CP108.2109](https://dx.doi.org/10.14714/CP108.2109).

Mahmoudi D, J Thatcher, LB Imaoka, and **D O’Sullivan**. 2024. From FOSS to profit: Digital spatial technologies and the mode of production. _Digital Geography and Society_ **7** 100101. doi: [10.1016/j.diggeo.2024.100101](https://dx.doi.org/10.1016/j.diggeo.2024.100101).

**O’Sullivan D**. 2024. Environment and Planning B and me; or what is lost in data. _Environment and Planning B: Urban Analytics and City Science_ **51**(5) 1045–1048. doi: [10.1177/23998083241246320](https://dx.doi.org/10.1177/23998083241246320).

Etherington TR, **D O’Sullivan**, GLW Perry, DR Richards, and J Wainwright. 2024. A least-cost network neutral landscape model of human sites and routes. _Landscape Ecology_ **39**(3) 52. doi: [10.1007/s10980-024-01836-w](https://dx.doi.org/10.1007/s10980-024-01836-w).

Antosz P, D Birks, B Edmonds, A Heppenstall, R Meyer, JG Polhill, **D O’Sullivan** and N Wijermans. 2023. What do you want theory for? A pragmatic analysis of the roles of &ldquo;theory&rdquo; in agent-based modelling. _Environmental Modelling & Software_ **168** 105802. doi: [10.1016/j.envsoft.2023.105802](https://dx.doi.org/10.1016/j.envsoft.2023.105802)

Lester PJ, **D O’Sullivan** and GLW Perry. 2023. Gene drives for invasive wasp control: Extinction is unlikely, with suppression dependent on dispersal and growth rates. _Ecological Applications_ **33**(7) e2912. doi: [10.1002/eap.2912](https://dx.doi.org/10.1002/eap.2912)

Bergmann L, LF Chaves, **D O’Sullivan** and RG Wallace. 2023. Dominant Modes of Agricultural Production Helped Structure Initial COVID-19 Spread in the U.S. Midwest. _ISPRS International Journal of Geo-Information_ **12**(5) 195. doi: [10.3390/ijgi12050195](https://dx.doi.org/10.3390/ijgi12050195)

Etherington T, F Morgan, **D O’Sullivan**. 2022, Binary space partitioning generates hierarchical and rectilinear neutral landscape models suitable for human-dominated landscapes. *Landscape Ecology* **37**(7) 1761–1769. doi: [10.1007/s10980-022-01452-6](https://dx.doi.org/10.1007/s10980-022-01452-6)
...
Thatcher JE, LR Bergmann, B Ricker, R Rose-Redwood, **D O’Sullivan**, TJ Barnes, LR Barnes&shy;moore, L Beltz Imaoka, R Burns, J Cinnamon, CM Dalton, C Davis, S Dunn, F Harvey, J-K Jung, E Kersten, L Knigge, N Lally, W Lin, D Mahmoudi, M Martin, W Payne, A Sheikh, T Shelton, E Sheppard, CW Strother, A Tarr, MW Wilson, and JC Young. 2016. Revisiting critical GIS. *Environment and Planning A* **48**(5) 815-824. doi: [10.1177/0308518X15622208](http://dx.doi.org/10.1177/0308518X15622208)
...
## Book chapters
Bergmann LR and **D O’Sullivan**. 2024. Space: towards a global sense of place. In *A Research Agenda for Spatial Analysis* (eds LJ Wolf, R Harris and AJ Heppenstall). Elgar Research Agendas. Edward Elgar Publishing. doi: [10.4337/9781802203233.00009](https://dx.doi.org/10.4337/9781802203233.00009).

C Andris and **D O’Sullivan**. 2019. Spatial Networks. In *Handbook of Regional Science* (eds MM Fischer and P Nijkamp). Springer. doi: [10.1007/978-3-642-36203-3_67-1](https://dx.doi.org/10.1007/978-3-642-36203-3_67-1).
...
## Dissertations
PhD: **O’Sullivan D**. 2000. [Graph-based Cellular Automaton Models of Urban Spatial Processes](https://southosullivan.com/phd/O'Sullivan_2000_Graph-based Cellular Automaton Models of Urban Spatial Processes.pdf). University College London.
