...
Welcome to **Geospatial Stuff** through which I offer expertise in data analytics and visualisation, simulation modelling, and [training](training.qmd), on all things geospatial. For more information [get in touch](mailto:osullivan512@gmail.com).

### Research
I am an accomplished geospatial researcher with over 25 years experience. I am an [Honorary Professor](https://profiles.auckland.ac.nz/david-osullivan){target="_blank"} at the University of Auckland and [Research Affiliate at Motu](https://www.motu.nz/about-us/people/david-osullivan/){target="_blank"}. You can find out more about my academic exploits from the drop-down above, or at [Google Scholar](https://scholar.google.com/citations?user=6guUlvgAAAAJ&hl=en&oi=ao){target="_blank"}. There are examples of current work in my [portfolio](portfolio.qmd) and [blog posts](blog.qmd). To summarise:
