...
The file extension is optional. Once in the session you can stash an existing file in the database as a table with the command (`D` is the DuckDB command line prompt)
