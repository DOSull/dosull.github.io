...
show_indicatrix = mo.ui.button(value = True, on_click = lambda x: not x, label = "Toggle indicatrix")
show_graticule = mo.ui.button(value = True, on_click = lambda x: not x, label = "Toggle graticule")
```
:::
