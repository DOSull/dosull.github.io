...
My explorations suggest that the most straightforward support for solving design challenges in this area lie in the [`cols4all` package](https://cols4all.github.io/cols4all-R/), although in this post I use a couple of other packages besides. First the usual suspects:
