...
To really dig into making such maps you might still need to write some code using the python [`weavingspace`](https://github.com/DOSull/weaving-space) module, BUT MapWeaver handles almost all use-cases and let's you export your map to PNG, SVG, geojson or geopackage formats for further design work in your preferred graphical or cartographic platform.
