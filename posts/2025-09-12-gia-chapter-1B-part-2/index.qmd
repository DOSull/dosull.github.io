...
It would perhaps be better accomplished in a drawing package, but it's worth knowing you can create one-side buffers too.
...
I am, of course, channeling the [flag of Cóte d'Ivoire](https://en.wikipedia.org/wiki/Flag_of_Ivory_Coast) here, and not the [flag of Ireland](https://en.wikipedia.org/wiki/Flag_of_Ireland).
