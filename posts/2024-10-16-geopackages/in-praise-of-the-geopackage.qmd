...
I should note that similar to R, the Python [`geopandas`](https://geopandas.org/en/stable/index.html) module in its [`read_file()`](https://geopandas.org/en/stable/docs/reference/api/geopandas.read_file.html), and [`list_layers()`](https://geopandas.org/en/stable/docs/reference/api/geopandas.list_layers.html#geopandas.list_layers) functions and its GeoDataframe's [`to_file()`](https://geopandas.org/en/stable/docs/reference/api/geopandas.GeoDataFrame.to_file.html) method offers the same functionality as discussed above.
