...
lightbox:
  ...
  loop: true
aliases:
  - "/posts/2021-10-22-spatstat-idw/spatstat-idw.html"
categories:
  - R
  - geospatial
  - tutorial
...
A [previous notebook](/posts/2021/10/21/kde/) showed an even quicker way to do this, but where the window will be formed from a bounding box (and where's the fun in that?)
