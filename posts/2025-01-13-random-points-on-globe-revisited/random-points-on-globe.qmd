...
```
1. I use the `outer` function to do all pairwise differences differences and products of data in the two supplied matrices more efficiently than by nested loops.
