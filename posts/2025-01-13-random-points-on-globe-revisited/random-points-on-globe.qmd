...
With the obvious exception of the uniform random pattern, which exhibits definite clumping, all of these seem to do a reasonable job of producing a random arrangement of points evenly distributed over the globe. The Halton and Sobol sequence generated patterns may have some (non-straight) linear 'clumps' although it's hard to know if this is a result of knowing that the generating processes involved can yield such alignments.
