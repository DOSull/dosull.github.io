...
description: "GeoCart never disappoints, and this year was no exception. Even so the conference could probably do with a few minor adjustments to its format."
...
lightbox:
  ...
  loop: true
aliases: 
  - "/posts/2024-08-30-geocart-24/geocart-24.html"
categories:
  - cartography
  - geospatial
  - aotearoa
...
![](alexander-turnbull-library.jpg)
...
![](ocean-mercier.jpg){style="width:40%; float:left; padding:0px 15px 15px 0px;"}[Ocean Mercier](https://people.wgtn.ac.nz/ocean.mercier)
...
+ [Karl Baker](https://www.linkedin.com/in/karl-baker-0864459/) spoke with great good humour and impressive clarity about the often rather sorry tale of the mishandling of New Zealand's longest placename in maps. Say it with me: [Te Taumata&shy;whaka&shy;tangi&shy;hanga&shy;kōauauo&shy;tamatea&shy;turi&shy;pūkākā&shy;piki&shy;maunga&shy;horo&shy;nuku&shy;pōkai&shy;whenua&shy;kita&shy;na&shy;tahu](https://gazetteer.linz.govt.nz/place/60053).^[I've gone with the longer not yet official form.] You can get some insight into the sorry tale of the use and abuse of the name from the [wikipedia talk page](https://en.wikipedia.org/wiki/Talk:Taumatawhakatangi%C2%ADhangakoauauotamatea%C2%ADturipukakapikimaunga%C2%ADhoronukupokaiwhen%C2%ADuakitanatahu) for the place name, and there's a concise correct pronunciation [:here](https://www.youtube.com/watch?v=QjS1dUJnVRQ).
...
+ [Jessie Colbert](https://profiles.auckland.ac.nz/jessie-colbert)'s presentation of work with [Katarzyna Sila-Nowicka](https://profiles.auckland.ac.nz/katarzyna-sila-nowicka) and [Dan Exeter](https://profiles.auckland.ac.nz/d-exeter) visualising maps of multiple deprivation was a model of completeness and clarity. I hope to maybe get involved in this work with my ['dots within dots'](https://dosull.github.io/30-day-maps-2023/maps/27-dot.html) and [weaving](https://github.com/DOSull/weaving-space/blob/main/presentations/NZCS-Aug-2022/slides/images/imd-weave.png) contributions.
