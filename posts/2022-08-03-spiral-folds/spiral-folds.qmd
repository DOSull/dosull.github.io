...
If you'd like an idea of how the fold works without going to all the trouble of actually making one, then visit [Amanda Ghassaei](https://amandaghassaei.com/){target="_blank"}'s [Origami Simulator](https://origamisimulator.org){target="_blank"} and navigate to **Examples - Tessellations - Whirlpool Spiral**.
