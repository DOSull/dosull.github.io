...
lightbox:
  ...
  loop: true
aliases: 
  - "/posts/2025-04-30-setting-up-a-jupyter-hub/jupyter-hub.html"
...
I still use notebooks all the time. It's probably not a great habit, but they're my go to for quickly exploring coding ideas. I even use them as a high level 'test harness' of sorts for the [`weavingspace` module](https://github.com/DOSull/weavingspace/tree/main/examples).
