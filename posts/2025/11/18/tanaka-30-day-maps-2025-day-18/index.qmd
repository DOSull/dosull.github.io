...
Now, layer them on top of one another southeast, northwest, and centred in that order, coloured black, white, and grey respectively.
...
g2 <- my_tanaka_contours(dem, 20, 20,
    colour = "#ff9020",
...
ggplot(donegal) +
    ...
    geom_contour_tanaka(aes(x = x, y = y, z = donegal),
        binwidth = 50,
        sun.angle = 45
    ) +
    coord_sf(expand = FALSE) +
