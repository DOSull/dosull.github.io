...
lightbox:
  match: auto
aliases: 
  - "/posts/2025-11-03-gia-chapter-1B-part-4B/index.html"
...
As noted, we are using the same study area as in the [previous post](/posts/2025/10/23/gia-chapter-1B-part-4/). For some context (and to learn about surface networks) go there and take a look. Meanwhile, here's a map for orientation again.
