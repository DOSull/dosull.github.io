...
lightbox:
  match: auto
aliases: 
  - "/posts/2025-10-27-xkcd-3122-interrupted-spheres/index.html"
...
```{ojs}
//| label: fig-dodecahedral-projection 
//| fig-cap: "A dodecahedral projection (code to generate this map shamelessly copied from from [Philippe Rivière (fil) at observablehq.com](https://observablehq.com/@fil/dodecahedral-projection))"
//| fig-width: 12
//| fig-height: 8
...
```{ojs}
//| label: d3-code-for-dodecahedral-projection
//| code-fold: true
/* This code is adapted (mostly be deletion and changing colours) from
