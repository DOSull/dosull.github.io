...
For more on how [MapWeaver](https://dosull.github.io/mapweaver/app/) does what it does, check out the [`weavingspace` code repository](https://github.com/DOSull/weavingspace).