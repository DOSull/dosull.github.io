...
lightbox:
  match: auto
aliases: 
  - "/posts/2025-09-09-gia-chapter-1B-part-1/index.html"
...
The [Gabriel graph](https://en.wikipedia.org/wiki/Gabriel_graph) is a thinned out close relative of the Delaunay triangulation, which we're about to see a [couple of sections later in this post](#triangulated-irregular-network-tin).
