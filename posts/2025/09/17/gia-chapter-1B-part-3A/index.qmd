...
lightbox:
  match: auto
aliases: 
  - "/posts/2025-09-17-gia-chapter-1B-part-3A/index.html"
...
In [this post](/posts/2025/09/09/gia-chapter-1B-part-1/) and [this one](/posts/2025/09/12/gia-chapter-1B-part-2/) I covered various GIS transformations from respectively points and lines. Here, we carry on down this path with some of the transformations available when your geospatial data consist of areas.
...
I mentioned that the distance surface in the [lines &rarr; fields section of the previous post](/posts/2025/09/12/gia-chapter-1B-part-2/#to-fields) might contain 'spoilers' for polygon skeletons. This wasn't quite correct. However there's certainly a way to derive the medial axis of a polygon by going via a line distance surface.
