...
lightbox:
  ...
  loop: true
aliases: 
  - "/posts/2025-01-13-random-points-on-globe-revisited/random-points-on-globe.html"
...
```{r}
#| label: fig-world-map
#| fig-cap: World map in Mollweide
#| fig-width: 8
#| fig-height: 4
ggplot() +
...
```{r}
#| label: fig-uniform-random
#| fig-cap: Simple uniform random pattern
#| fig-width: 8
#| fig-height: 4
...
```{r}
#| label: fig-uniform-random-cosine-corrected
#| fig-cap: Uniform random pattern with cosine correction
#| fig-width: 8
#| fig-height: 4
...
```{r}
#| label: fig-stratified-point-pattern
...
```{r}
#| label: fig-offset-halton-sequence
#| fig-cap: Points generated by a Halton sequence
#| fig-width: 8
#| fig-height: 4
...
```{r}
#| label: fig-homebrew-blue-noise
#| fig-cap: A pattern generated using a 'blue noise' algorithm by iteratively choosing the most remote random additional point among a set of choices
#| fig-width: 8
#| fig-height: 4
#| echo: false
...
We now apply a transformation from the lat-lon Cartesian coordinates to the globe that is equal-area as shown in the [previous post](/posts/2021/10/20/random-even-points-on-the-globe/). We can combine all the points into a single data set and use `facet_wrap` for side-by-side comparison.

```{r}
#| label: fig-all-sets-on-globe
#| fig-cap: Side-by-side comparison of five patterns projected onto the globe
#| fig-width: 8
#| fig-height: 7
...
```{r}
#| label: fig-all-sets-on-globe-hexbins
#| fig-cap: Side-by-side comparison of hexbin density plots of the five point patterns
#| fig-width: 8
#| fig-height: 7
...
```{r}
#| label: fig-blue-noise-in-unit-square
#| fig-cap: A blue noise pattern in Euclidean space
#| fig-width: 6
#| fig-height: 6
