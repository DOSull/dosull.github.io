...
[Go to the model](https://southosullivan.com/misc/distributed-branching-process-RC-web.html){.button-link target="_blank" style="font-family:sans-serif; background-color:#396; color:#cec; padding:10px; box-shadow: 5px 5px 5px #666; border-radius:5px; text-decoration: none;"}
:::
