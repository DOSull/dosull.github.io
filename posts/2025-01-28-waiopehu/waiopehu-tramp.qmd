...
It _looks like_ a pretty relentless uphill tramp. But there really are quite a few sections of downhill. To emphasise this we can add to plot, using the downhill star and end flags in the data.
